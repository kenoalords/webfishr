  ...
  if (email !== '') {
    ...
    $.ajax({
      ...
      success: function success(res) {
        ...
        if (res.saved === true) {
          swal('You are the best!', 'Your subscription to our newsletter was successful. Please check your email and click the activation link to receive our goodies', 'success');
          $(form).trigger('reset');
        } else if (res.saved === 'duplicate') {
          swal('You have already subscribed for our newsletter');
          $(form).trigger('reset');
        }
      },
